...
class Inbound extends BaseRequest
{
    /**
    ...
    public function domains()
    {
        ...
        return $this->mandrill->call('inbound/domains', $_params);
    }
    ...
    public function addDomain($domain)
    {
        ...
        return $this->mandrill->call('inbound/add-domain', $_params);
    }
    ...
    public function checkDomain($domain)
    {
        ...
        return $this->mandrill->call('inbound/check-domain', $_params);
    }
    ...
    public function deleteDomain($domain)
    {
        ...
        return $this->mandrill->call('inbound/delete-domain', $_params);
    }
    ...
    public function routes($domain)
    {
        ...
        return $this->mandrill->call('inbound/routes', $_params);
    }
    ...
    public function addRoute($domain, $pattern, $url)
    {
        ...
        return $this->mandrill->call('inbound/add-route', $_params);
    }
    ...
    public function updateRoute($id, $pattern = null, $url = null)
    {
        ...
        return $this->mandrill->call('inbound/update-route', $_params);
    }
    ...
    public function deleteRoute($id)
    {
        ...
        return $this->mandrill->call('inbound/delete-route', $_params);
    }
    ...
    public function sendRaw($raw_message, $to = null, $mail_from = null, $helo = null, $client_address = null)
    {
        ...
        return $this->mandrill->call('inbound/send-raw', $_params);
    }
}
