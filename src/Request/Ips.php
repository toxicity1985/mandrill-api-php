...
class Ips extends BaseRequest
{
    ...
    public function getList()
    {
        ...
        return $this->mandrill->call('ips/list', $_params);
    }
    ...
    public function info($ip)
    {
        ...
        return $this->mandrill->call('ips/info', $_params);
    }
    ...
    public function provision($warmup = false, $pool = null)
    {
        ...
        return $this->mandrill->call('ips/provision', $_params);
    }
    ...
    public function startWarmup($ip)
    {
        ...
        return $this->mandrill->call('ips/start-warmup', $_params);
    }
    ...
    public function cancelWarmup($ip)
    {
        ...
        return $this->mandrill->call('ips/cancel-warmup', $_params);
    }
    ...
    public function setPool($ip, $pool, $create_pool = false)
    {
        ...
        return $this->mandrill->call('ips/set-pool', $_params);
    }
    ...
    public function delete($ip)
    {
        ...
        return $this->mandrill->call('ips/delete', $_params);
    }
    ...
    public function listPools()
    {
        ...
        return $this->mandrill->call('ips/list-pools', $_params);
    }
    ...
    public function poolInfo($pool)
    {
        ...
        return $this->mandrill->call('ips/pool-info', $_params);
    }
    ...
    public function createPool($pool)
    {
        ...
        return $this->mandrill->call('ips/create-pool', $_params);
    }
    ...
    public function deletePool($pool)
    {
        ...
        return $this->mandrill->call('ips/delete-pool', $_params);
    }
    ...
    public function checkCustomDns($ip, $domain)
    {
        ...
        return $this->mandrill->call('ips/check-custom-dns', $_params);
    }
    ...
    public function setCustomDns($ip, $domain)
    {
        ...
        return $this->mandrill->call('ips/set-custom-dns', $_params);
    }
