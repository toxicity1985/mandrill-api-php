...
class Messages extends BaseRequest
{
    ...
    public function send($message, $async = false, $ip_pool = null, $send_at = null)
    {
        ...
        return $this->mandrill->call('messages/send', $_params);
    }
    ...
    public function sendTemplate(
        ...
        return $this->mandrill->call('messages/send-template', $_params);
    }
    ...
    public function search(
        ...
        return $this->mandrill->call('messages/search', $_params);
    }
    ...
    public function searchTimeSeries($query = '*', $date_from = null, $date_to = null, $tags = null, $senders = null)
    {
        ...
        return $this->mandrill->call('messages/search-time-series', $_params);
    }
    ...
    public function info($id)
    {
        ...
        return $this->mandrill->call('messages/info', $_params);
    }
    ...
    public function content($id)
    {
        ...
        return $this->mandrill->call('messages/content', $_params);
    }
    ...
    public function parse($raw_message)
    {
        ...
        return $this->mandrill->call('messages/parse', $_params);
    }
    ...
    public function sendRaw(
        ...
        return $this->mandrill->call('messages/send-raw', $_params);
    }
    ...
    public function listScheduled($to = null)
    {
        ...
        return $this->mandrill->call('messages/list-scheduled', $_params);
    }
    ...
    public function cancelScheduled($id)
    {
        ...
        return $this->mandrill->call('messages/cancel-scheduled', $_params);
    }
    ...
    public function reschedule($id, $send_at)
    {
        ...
        return $this->mandrill->call('messages/reschedule', $_params);
    }
