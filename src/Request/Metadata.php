...
class Metadata extends BaseRequest
{
    ...
    public function getList()
    {
        ...
        return $this->mandrill->call('metadata/list', $_params);
    }
    ...
    public function add($name, $view_template = null)
    {
        ...
        return $this->mandrill->call('metadata/add', $_params);
    }
    ...
    public function update($name, $view_template)
    {
        ...
        return $this->mandrill->call('metadata/update', $_params);
    }
    ...
    public function delete($name)
    {
        ...
        return $this->mandrill->call('metadata/delete', $_params);
    }
