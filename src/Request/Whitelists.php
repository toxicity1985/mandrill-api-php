...
class Whitelists extends BaseRequest
{
    /**
    ...
    public function add($email, $comment = null)
    {
        ...
        return $this->mandrill->call('whitelists/add', $_params);
    }
    ...
    public function getList($email = null)
    {
        ...
        return $this->mandrill->call('whitelists/list', $_params);
    }
    ...
    public function delete($email)
    {
        ...
        return $this->mandrill->call('whitelists/delete', $_params);
    }
}
