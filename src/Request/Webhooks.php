...
class Webhooks extends BaseRequest
{
    /**
    ...
    public function getList()
    {
        ...
        return $this->mandrill->call('webhooks/list', $_params);
    }
    ...
    public function add($url, $description = null, $events = array())
    {
        ...
        return $this->mandrill->call('webhooks/add', $_params);
    }
    ...
    public function info($id)
    {
        ...
        return $this->mandrill->call('webhooks/info', $_params);
    }
    ...
    public function update($id, $url, $description = null, $events = array())
    {
        ...
        return $this->mandrill->call('webhooks/update', $_params);
    }
    ...
    public function delete($id)
    {
        ...
        return $this->mandrill->call('webhooks/delete', $_params);
    }
}
